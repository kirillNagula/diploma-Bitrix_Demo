...
public class TaskController {
    ...
    public ModelAndView post(@ModelAttribute("task") TaskDto task, ModelAndView modelAttribute, Authentication authentication){
        System.out.println(task);
        Task task1 = new Task();
        task1.setAuthor(userService.showUserById(task.getAuthorId()));
